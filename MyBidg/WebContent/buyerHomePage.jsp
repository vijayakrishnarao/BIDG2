 ...
 <body>
        ...
        <script>
         ...
         var timing = setInterval( // you're making an interval - a thing, that is updating content after number of miliseconds, that you're writing after comma as second parameter
           ...
           <div class="card-body">
            <button >
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Icons8_flat_like.svg/1024px-Icons8_flat_like.svg.png" style="height:40px" style="width:20px">
              </button>
              <button>
              <img src="https://www.mangoextensions.com/media/catalog/product/cache/1/image/1200x1200/9df78eab33525d08d6e5fb8d27136e95/a/j/ajaxaddtocartsite.jpg" style="height:40px" style="width:20px">
                </button>
                <button class="btn btn-primary" style="height:45px">BID NOW</button>
            </div>
                <div>
...
<br><br><br>
        ...
        <div class="container">
        <center> <strong> UPCOMING AUCTIONS </strong></center>
        </div>
        <br>
    ...
    <div class="col-lg-4"> <center><div></div>
    <div class="card" style="width: 18rem;">
